...
# name
PRODUCT_RELEASE_NAME := ls970

# device
$(call inherit-product-if-exists, device/lge/ls970/full_ls970.mk)
...
PRODUCT_BRAND := LGE
PRODUCT_NAME := carbon_ls970
PRODUCT_MODEL := LG-LS970
PRODUCT_MANUFACTURER := LGE
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=carbon.ls970.$(shell date +%m%d%y).$(shell date +%H%M%S)
